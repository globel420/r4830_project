...
| 02 | [ ] | Baseline RX health | RX count increases while charger is active | 5 min |
| 03 | [ ] | Keepalive/poll sanity | Keepalive on/off does not break RX/TX | 5 min |
| 04 | [ ] | Output Voltage Setpoint (`0x07`) | ACK and telemetry/readback reflect new value | 6 min |
| 05 | [ ] | Output Current Limit (`0x08`) | ACK and telemetry/readback reflect new value | 6 min |
| 06 | [ ] | Output Enable (`0x0C`) ON/OFF | Both directions ACK, charger behavior matches | 8 min |
...
| 09 | [ ] | Power-Off Current (`0x15`) | ACK and readback for safe values (for example 0.1/0.3/1.0) | 8 min |
| 10 | [ ] | Two-Stage Charging (`0x20`) | ACK both ways; behavior/state confirmed | 6 min |
| 11 | [ ] | Stage 2 Voltage (`0x21`) | ACK and readback value match | 6 min |
| 12 | [ ] | Stage 2 Current (`0x22`) | ACK and readback value match | 6 min |
| 13 | [ ] | Manual Output Control (`0x23`) | ACK both ways; behavior/state confirmed | 6 min |
| 14 | [ ] | Soft Start Time (`0x26`) | ACK and readback value match | 6 min |
| 15 | [ ] | Power Limit (`0x27`) | ACK and readback value match | 6 min |
| 16 | [ ] | Charge Statistics Reset (`0x13`) | Command accepted and expected reset effect observed | 5 min |
...
| 25 | [ ] | Reconnect/stability soak | 10+ minute run, repeated save actions, no RX/TX desync | 20 min |
...
- Best-case (no blockers): about **3.5 to 4.5 hours**.
